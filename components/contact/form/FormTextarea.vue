  ...
  <div class="flex flex-col gap-2">
    ...
    <div class="relative group">
      ...
      <component
        ...
        :is="iconComponent"
        class="absolute left-3 top-3 w-5 h-5 text-gray-400 transition-colors duration-200 pointer-events-none group-focus-within:text-black stroke-current stroke-[1.5]"
      />
      ...
      <textarea
        ...
        :class="['w-full px-4 rounded-lg border-2 bg-white text-gray-900 placeholder-gray-400 transition-all duration-200 focus:outline-none focus:border-primary/50 focus:ring-[0.5px] focus:ring-primary/20 resize-none font-inter', props.compact ? 'py-2 text-sm' : 'py-2.5 text-base', { 'pl-10': iconComponent && showIcon }, error ? 'border-red-500 animate-shake' : 'border-gray-300']"
        @input="handleInput"
        @focus="handleFocus"
        @blur="handleBlur"
      />
